...
const P2ptable = () => {
    ...
    const [data, setData] = useState(
        document.querySelectorAll('#p2p_sell_table tbody tr')
    )
    ...
    useEffect(() => {
        setData(document.querySelectorAll('#p2p_sell_table tbody tr'))        
    }, [test])    
    ...
    return (
        <div className="table-responsive dataTabletrade">
            <div id='p2p_sell_table' className='dataTables_wrapper no-footer'>
                <table id="example-history" className="table shadow-hover mb-0 display orderbookTable dataTable no-footer" style={{minWidth:"845px"}}>
                    <thead>
                        <tr>
                ...
                <div className='d-sm-flex justify-content-sm-between justify-content-center align-items-center'>
                    <div className='dataTables_info text-center'>
