...
const marketDataTable = [   
    ...
    {price:'$0.2921', highlow:'30,585.00/21,250.00', volume:'20,110.00', cap:'Loss', logo : SVGICON.AustralianDoller, name:'AUD', subtitle:'Australian Doller',change:'+11'},
...
const NewLisitngTab = () => {
    ...
    const [data, setData] = useState(
        document.querySelectorAll('#listing_table tbody tr')
    )
    ...
    useEffect(() => {
        setData(document.querySelectorAll('#listing_table tbody tr'))        
    }, [test])    
    ...
    return (
        <div className="table-responsive dataTabletrade">
            <div id='listing_table' className='dataTables_wrapper no-footer'>
