...
const P2ptable = () => {
    ...
    const [data, setData] = useState(
        document.querySelectorAll('#p2p_buy_table tbody tr')
    )
    ...
    useEffect(() => {
        setData(document.querySelectorAll('#p2p_buy_table tbody tr'))        
    }, [test])    
    ...
    return (
        <div className="table-responsive dataTabletrade">
            <div id='p2p_buy_table' className='dataTables_wrapper no-footer'>
                <table id="example-history" className="table shadow-hover display mb-0 orderbookTable dataTable no-footer" style={{minWidth:"845px"}}>
                    <thead>
                        <tr>
