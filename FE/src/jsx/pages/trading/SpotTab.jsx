...
const SpotTab = () => {
    ...
    const [data, setData] = useState(
        document.querySelectorAll('#sport_table tbody tr')
    )
    ...
    useEffect(() => {
        setData(document.querySelectorAll('#sport_table tbody tr'))        
    }, [test])    
    ...
    return (
        <div className="table-responsive dataTabletrade">
            <div id='sport_table' className='dataTables_wrapper no-footer'>
